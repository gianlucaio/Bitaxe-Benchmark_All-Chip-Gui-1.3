"""
Bitaxe All Model Hashrate Benchmark — GUI Edition  v1.7
...
"""
        ...
        md += f"\n---\n\n*Generated by BitaxeBenchGui v1.7*\n"
...
class AnalysisWindow(tk.Toplevel):
    ...
    def __init__(self, parent):
        super().__init__(parent)
        self.title("📊 Benchmark Analysis v1.7")
        self.configure(bg=C["bg"])
        self.resizable(True, True)
...
class App(tk.Tk):
    ...
    def _build_ui(self):
        ...
        tk.Label(
            banner, text="⛏  BITAXE ALL CHIP BENCHMARK v1.7",
            bg=C["accent"], fg="#111827",
